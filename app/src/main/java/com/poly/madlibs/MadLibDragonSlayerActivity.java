    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                story += "Chills ran down " + etMage.getText() + "'s back. They knew what was going to happen. ";
                story += "\n\n\"Fall back!\" " + etMage.getText() + " calls out. ";
                ...
                story += "" + etMage.getText() + " collapses to the ground. The warrior remains silent. Soon, a " + etColor.getText() + " colored orb formed from the mage's chest. Clean and pristine. ";
                story += "The warrior stuff it into a pocket and walks over to the mutilated dragon, sheathing their sword.\n\n";
                story += " Within the mess was a glowing azure orb the size of their palm. Grabbing it, the warrior turns around and starts walking towards the shattered gate. ";
